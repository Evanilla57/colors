//Constructor class to render svg logo with text, text color, shape
class SVG {
    constructor() {
        this.text = "";
        this.shape = "";
...
//Class with constructor intializing color
class Shape {
...
//Function to render logo based on selected data
...
//Export
module.exports = {shapeMold, Circle, Square, Triangle};